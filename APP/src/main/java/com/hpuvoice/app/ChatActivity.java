...
import com.hpuvoice.adapter.ChatLVAdapter;
import com.hpuvoice.adapter.FaceGVAdapter;
import com.hpuvoice.adapter.FaceVPAdapter;
import com.hpuvoice.modle.ChatInfo;
import com.hpuvoice.uichat.CustomEditText;
import com.hpuvoice.uichat.DropdownListView;
import com.hpuvoice.util.TuLingApi;
...
public class ChatActivity extends Activity implements OnClickListener, DropdownListView.OnRefreshListenerHeader {
    ...
    private void initViews() {
        ...
        final ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, objectItems);
        ...
        choose_tlking_object.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ChatActivity.this, "你选择的是:" + spinnerAdapter.getItem(position), Toast.LENGTH_SHORT).show();
            }
    ...
    private class LoadMsg extends AsyncTask<String, String, String> {
        @Override
        ...
        protected String doInBackground(String... args) {
            String orignData = TuLingApi.getData(reply);
            if (orignData != null) {
                textData = TuLingApi.parseRes(orignData);
            } else {
                textData = null;
            }
        ...
        protected void onPostExecute(String textData) {
            if (textData == null) {
                infos.add(getChatInfoFrom("哇哦，没有人回复你，需要积攒RP哦 *"));
            } else {
                infos.add(getChatInfoFrom(textData));
            }
            mLvAdapter.setList(infos);
            mLvAdapter.notifyDataSetChanged();
            mListView.setSelection(infos.size() - 1);
