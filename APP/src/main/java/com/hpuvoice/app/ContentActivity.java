...
import com.hpuvoice.fragment.CsdnFragment;
import com.hpuvoice.fragment.HpuFragment;
import com.hpuvoice.fragment.MenuDrawer;
import com.hpuvoice.fragment.OpenclassFragment;
import com.hpuvoice.fragment.WallFragment;
import com.hpuvoice.view.PagerSlidingTabStrip;
...
public class ContentActivity extends FragmentActivity implements ViewPager.OnPageChangeListener {
    ...
    private class mPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private String Title[] = {"   HPU    ", "   公开课  ", "   CSDN   ", "   学霸墙   "};
        ...
        public Fragment getItem(int arg0) {
            if (arg0 == 0) {
                return HpuFragment.newInstance("para1", "para2");
            } else if (arg0 == 1) {
                return new OpenclassFragment();
            } else if (arg0 == 2) {
                return new CsdnFragment().newInstance("", "");
                //return new OpenclassFragment();
            } else {
